# -*- coding: utf-8 -*-
"""Installer for the collective.faceted.map package."""
...
setup(
    ...
    url="https://pypi.python.org/pypi/collective.faceted.map",
    ...
    target = plone
    [console_scripts]
    update_locale = collective.faceted.map.locales.update:update_locale
    """,
)
